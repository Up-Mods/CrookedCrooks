...
public enum CrookMaterials implements ToolMaterial {
	...
	TECH_REBORN_BRONZE(2, 375, 7.0F, 2.25F, 6, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:bronze_ingots")))),
	RUBY(2, 750, 6.0F, 1.5F, 10, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:rubies")))),
	SAPPHIRE(3, 1000, 7.0F, 1.5F, 12, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:sapphires")))),
	PERIDOT(2, 750, 7.0F, 1.5F, 12, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:peridot_gems")))),
	// Applied Energistics 2 Materials
	CERTUS_QUARTZ(ToolMaterials.IRON, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:certus_quartz")))),
	NETHER_QUARTZ(ToolMaterials.IRON, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:quartz")))),
	FLUIX(
		...
		() -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:fluix")))
	),
	// Industrial Revolution Materials
	TIN(1, 200, 4.0F, 1.0F, 14, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:tin_ingots")))),
	COPPER(2, 300, 4.5F, 1.0F, 14, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:copper_ingots")))),
	STEEL(3, 600, 4.5F, 2.0F, 14, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:steel_ingots")))),
	LEAD(2, 900, 3.0F, 2.0F, 8, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:lead_ingots")))),
	INDREV_BRONZE(2, 500, 3.5F, 2.5F, 12, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:bronze_ingots")))),
	SILVER(2, 500, 5.0F, 1.0F, 24, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:lead_ingots")))),
	/*
	...
	*/
	...
	ROSE_GOLD(2, 900, 9.0F, 3.0F, 17, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:copper_ingots")))),
	GILDED_NETHERITE(4, 2000, 9.0F, 4.0F, 24, () -> Ingredient.ofTag(TagKey.of(RegistryKeys.ITEM, new Identifier("c:netherite_ingots"))));
